...
class _PickupConfirmViewState extends State<PickupConfirmView> {
  ...
  bool get _hasStory => !_viewModel.storySkipped && _viewModel.storyText.trim().isNotEmpty;

  void _shareCard() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('📤 Compartir en redes sociales (se integrará con share_plus)'),
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamedAndRemoveUntil(
                  context, AppRoutes.pickupStep1, (route) => false,
                );
              },
      ...
      child: Column(
        ...
        children: [
          ...
          RichText(
            textAlign: TextAlign.center,
            text: const TextSpan(
              style: TextStyle(fontSize: 13, color: AppColors.darkestTeal, height: 1.6),
              children: [
                TextSpan(
                  text: 'Si quieres ver más historias, ',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                TextSpan(text: 'publica tu historia con el botón de aquí y se creará un post automático con tu historia, foto y el '),
                TextSpan(
                  text: '#capsulasdememoriamed',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
                TextSpan(text: '; en este hashtag se encuentran las historias de más personas que quisieron redimir sus dispositivos.'),
              ],
            ),
          ),
  ...
  Widget _buildShareableCard() {
    ...
    final String brandName = _viewModel.brand.isNotEmpty ? _viewModel.brand : '—';
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: imageBytes != null
                        ...
                        : Container(
                            ...
                            child: const Icon(Icons.camera_alt,
                              color: AppColors.lightTeal, size: 48),
                          ),
                  ),
                ),
                ...
                Padding(
                  ...
                  child: Container(height: 1, color: AppColors.teal.withOpacity(0.3)),
                ),
