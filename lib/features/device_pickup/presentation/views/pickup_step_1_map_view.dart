...
class _PickupStep1MapViewState extends State<PickupStep1MapView> {
  ...
  void _onViewModelChange() {
    setState(() {
      if (_viewModel.isRouteCalculated && _viewModel.selectedPoint != null) {
        _mapController.move(
          LatLng(
            (_mockUserLocation.latitude + _viewModel.selectedPoint!.location.latitude) / 2,
            (_mockUserLocation.longitude + _viewModel.selectedPoint!.location.longitude) / 2,
          ),
          13.5,
        );
      } else if (_viewModel.isPointSelected && _viewModel.selectedPoint != null) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                ...
                if (_viewModel.isRouteCalculated && _viewModel.selectedPoint != null)
                  PolylineLayer(
                    polylines: <Polyline<Object>>[
                      Polyline<Object>(
                        points: [_mockUserLocation, _viewModel.selectedPoint!.location],
                      ...
                      return Marker(
                        ...
                        child: GestureDetector(
                          ...
                          child: _buildRecycleMarker(
                            isSelected: _viewModel.selectedPoint?.id == point.id,
                          ),
                        ),
                      );
                    }),
          ...
          // 3. Bottom: either the default panel or the point card
          Positioned(
    ...
    return ClipPath(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            const StepperWidget(currentStep: 1, activeColor: AppColors.darkestTeal),
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.arrow_back, color: AppColors.darkTeal, size: 18),
                      ),
                    ),
                    const SizedBox(width: 10),
                    const Text(
                      'Punto de recolección',
                      style: TextStyle(color: AppColors.darkestTeal, fontWeight: FontWeight.bold, fontSize: 16),
                    ),
                  ]),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: const DecorationImage(
                        image: NetworkImage(
                          'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a4/Medell%C3%ADn%2C_Colombia_%28Unsplash%29.jpg/1280px-Medell%C3%ADn%2C_Colombia_%28Unsplash%29.jpg',
                        ),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ...
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text('Dirección ', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkestTeal, fontSize: 13)),
                      const Icon(Icons.location_on, color: AppColors.darkTeal, size: 14),
                    ],
                  ),
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: const TextStyle(color: AppColors.darkestTeal, fontSize: 13),
                    ),
                  ),
                  ...
                  // Dispositivos
                  const Row(children: [
                    Text('Dispositivos permitidos ', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkestTeal, fontSize: 13)),
                    Icon(Icons.devices, color: AppColors.darkTeal, size: 14),
                  ]),
                  const Padding(
                    padding: EdgeInsets.only(left: 4, top: 2),
                    child: Text('•  Teléfonos  •  Televisores  •  Cámaras  •  Consolas',
                      style: TextStyle(color: AppColors.darkestTeal, fontSize: 12)),
                  ),
                  const SizedBox(height: 10),

                  // Horarios
                  const Row(children: [
                    Text('Horarios ', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkestTeal, fontSize: 13)),
                    Icon(Icons.access_time, color: AppColors.darkTeal, size: 14),
                  ]),
                  const Padding(
                    padding: EdgeInsets.only(left: 4, top: 2),
                    child: Text('7:00 am - 6:00 pm (Lun - Sáb)',
                      style: TextStyle(color: AppColors.darkestTeal, fontSize: 12)),
                  ),
                  ...
                  if (_viewModel.isRouteCalculated)
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          Row(children: [
                            Icon(Icons.directions_walk, color: AppColors.darkTeal, size: 16),
                            SizedBox(width: 4),
                            Text('2.5 km', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkestTeal, fontSize: 13)),
                          ]),
                          Row(children: [
                            Icon(Icons.directions_car, color: AppColors.darkTeal, size: 16),
                            SizedBox(width: 4),
                            Text('10 min', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkestTeal, fontSize: 13)),
                          ]),
                        ],
                      ),
                    )
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: const Text('Ir a la dirección', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
          ...
          Padding(
            ...
            child: PrimaryButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, AppRoutes.pickupStep2, arguments: _viewModel);
              },
            ),
          ),
        ],
  ...
  Widget _buildSearchBar() {
    return Container(
      decoration: BoxDecoration(
        color: AppColors.darkestTeal.withOpacity(0.9),
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: TextStyle(color: AppColors.white.withOpacity(0.6), fontSize: 14),
  ...
  Widget _buildRecycleMarker({bool isSelected = false}) {
    return Container(
      ...
      child: Icon(Icons.sync, color: AppColors.white, size: isSelected ? 24 : 20),
    );
  }
    ...
    return Container(
      ...
      child: Center(
        child: Container(width: 8, height: 8,
          decoration: const BoxDecoration(color: AppColors.darkestTeal, shape: BoxShape.circle),
        ),
      ),
    );
  }
